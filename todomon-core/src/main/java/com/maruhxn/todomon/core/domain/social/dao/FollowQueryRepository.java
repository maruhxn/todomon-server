...
import com.maruhxn.todomon.core.domain.member.domain.QMember;
import com.maruhxn.todomon.core.domain.social.domain.FollowRequestStatus;
import com.maruhxn.todomon.core.domain.social.domain.QFollow;
import com.maruhxn.todomon.core.domain.social.dto.response.*;
...
public class FollowQueryRepository {
    ...
    public Page<FollowRequestItem> findPendingFollowRequestsWithPaging(Long memberId, Pageable pageable) {
        ...
        List<FollowRequestItem> results = query
                ...
                .where(followStatusIs(FollowRequestStatus.PENDING), followeeIdIs(memberId))
    ...
    public Page<? extends FollowerItem> findFollowersByMemberIdWithPaging(Long memberId, Pageable pageable) {
        ...
        List<FollowerItem> results = query
                ...
                .where(followeeIdIs(memberId), followStatusIs(FollowRequestStatus.ACCEPTED))
                .orderBy(follow.createdAt.desc())
                .offset(pageable.getOffset())
                .limit(pageable.getPageSize())
                .fetch();
                                        ...
                                        JPAExpressions
                                                ...
                                                .where(
                                                        subFollow.followee.id.eq(follower.id)
                                                                ...
                                                                .and(subFollow.status.eq(FollowRequestStatus.ACCEPTED)))
                                                .exists(),
    ...
    public Page<FollowingItem> findFollowingsByMemberIdWithPaging(Long memberId, Pageable pageable) {
        ...
        List<FollowingItem> results = query
                ...
                .where(followerIdIs(memberId), followStatusIs(FollowRequestStatus.ACCEPTED))
                .orderBy(follow.createdAt.desc())
                .offset(pageable.getOffset())
                .limit(pageable.getPageSize())
                .fetch();
