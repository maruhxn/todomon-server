...
public class OverallRankController {
    ...
    public DataResponse<List<TodoAchievementRankItem>> getOverallRankingOfDailyAchievement() {
    ...
    public DataResponse<List<TodoAchievementRankItem>> getOverallRankingOfWeeklyAchievement() {
        return DataResponse.of("전체 주간 투두 달성 랭킹 조회 성공", overallRankQueryService.getRankingOfWeeklyAchievement());
    }

    // 전체 일관성 레벨 랭킹 조회
    @GetMapping("/diligence")
    public DataResponse<List<DiligenceRankItem>> getOverallRankingOfDiligence() {
    ...
    public DataResponse<List<CollectedPetRankItem>> getOverallRankingOfCollection() {
