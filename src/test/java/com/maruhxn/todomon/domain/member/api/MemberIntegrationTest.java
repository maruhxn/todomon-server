...
class MemberIntegrationTest extends ControllerIntegrationTestSupport {
    ...
    void getProfile() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("data.titleName").value("title"))
                .andExpect(jsonPath("data.titleColor").value("#000000"))
                .andExpect(jsonPath("data.followerCnt").value(1L))
                .andExpect(jsonPath("data.followingCnt").value(2L))
